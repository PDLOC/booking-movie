...
export default function User() {
    ...
    const renderListUser = () => {
        return items?.map((item) => {
            return (
                <tr key={item?.taiKhoan} className="bg-neutral-primary-soft border-b border-default hover:bg-neutral-secondary-medium">
                    ...
                    <td className="px-6 py-4 flex">
                        ...
                        <div className="ml-2">
                            <button onClick={(e) => handleDelete(item?.taiKhoan, e)}
    ...
    return (
        <div>
            <div className="flex">
                <h1 className="text-lg pb-3 uppercase font-bold">Quản lý người dùng</h1>
