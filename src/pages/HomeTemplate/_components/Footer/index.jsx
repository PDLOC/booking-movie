            ...
            <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-heading uppercase">Giới thiệu</h2>
                            <ul className="text-body font-medium">
                                <li className="mb-4">
                                    <a href="about" className="hover:underline">Movie Booking Ticket</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-heading uppercase">Theo dõi chúng tôi</h2>
                            <ul className="text-body font-medium">
                                <li className="mb-4">
                                    <a href="https://github.com/PDLOC/booking-movie" className="hover:underline ">Github</a>
                                </li>
                            </ul>
                        </div>
                    </div>
